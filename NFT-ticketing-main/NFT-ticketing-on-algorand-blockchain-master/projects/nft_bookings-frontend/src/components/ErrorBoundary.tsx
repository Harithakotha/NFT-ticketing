...
class ErrorBoundary extends React.Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  render(): ReactNode {
    if (this.state.hasError) {
      ...
      return (
        <div className="hero min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
          <div className="hero-content text-center rounded-lg p-6 max-w-md bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 mx-auto shadow-lg">
